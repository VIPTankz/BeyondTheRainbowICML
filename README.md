...
After installing the environment, you can use main.py to perform runs. The default game is BattleZone, however you can change this using the  --game "GameName".
