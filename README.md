...
Also note by default we use 64 parallel environments, and even more for evaluation. This can be quite RAM intensive, especially on Windows.
If this is an issue, try reducing the number of evaluation environments, training environments or replay buffer size.
